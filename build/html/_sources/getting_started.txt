...
BounCA has a few easy ways to quickly get started, each one appealing to a different security level. Read through to see what suits your particular needs.
...
The BounCA `Ansible`_ role offers you an automatic deployment of BounCA. This is the recommended way of installing BounCA. Use this script for virtual machines or bare metal (very secure) installation.
...
Use this profile if you want to try BounCA or use BounCA as a locally deployed tool to generate self-signed SSL certificates.
...
Download the `BounCA source`_ to install BounCA yourself. You need an Python 3.4+ environment and a PostgreSQL database.
...
.. _BounCA source: https://www.github.com/repleo/bounca
